...
class StatsView extends Component {
    constructor(props) {
        ...
        this.state = {
            lastFiveRequests: [],
            apiLimits: { Data: { calls_made: {}, calls_left: {} } }
        };
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {this.state.apiLimits.Data.calls_made.hour}
                                </td>
                                <td>
                                    {this.state.apiLimits.Data.calls_left.hour}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    {
                                        this.state.apiLimits.Data.calls_made
                                            .minute
                                    }
                                </td>
                                <td>
                                    {
                                        this.state.apiLimits.Data.calls_left
                                            .minute
                                    }
                                </td>
                            </tr>
